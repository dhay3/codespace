...
2. Prove all the principles have criterion and the design is viable(each pivotal components is able to independent substantiation) in `docs/auto/DESIGN_PROVE.md`.
3. Update comprehension based on `docs/auto/*`.
